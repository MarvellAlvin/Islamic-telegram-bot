...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "📌 *Menu Utama:*\n\n"
        "/jadwal kota - Cek Jadwal Sholat\n"
        "/maghrib kota - Cek Jadwal Sholat Maghrib\n"
        "/dzikir - Dapatkan Dzikir Harian\n"
        "/renungan - Dapatkan Renungan Harian\n"
        "/alhusna - Dapatkan Asmaul Husna Lengkap\n"
        "/husna 95 - Dapatkan Asmaul Husna Dengan Nomor Urutan\n"
        "/listsurat - Dapatkan List Surah Dalam Al-Qur'an\n"
        "/surah 33 - Dapatkan Surah Dengan Nomor Urut\n"
        "/ayat 1 2 - Dapatkan Ayat Dari Nomor Surah dan Nomor Ayat\n"
        "/hijriyah - Cek Kalender Hijriyah\n"
        "/doa - Dapatkan Doa Harian\n"
        "/hadist - Dapatkan Hadist Acak"
    )

    keyboard = [
        [InlineKeyboardButton("📜 Tentang Kami", callback_data="about"),
...
async def info(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(text_info, reply_markup=reply_markup)

async def button_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    await query.answer()  # Hindari timeout error

    if query.data == "about":
        text = escape_markdown("📜 Tentang Kami\nKami adalah komunitas yang berbagi ilmu dan kebahagiaan! ✨", version=2)
        keyboard = [[InlineKeyboardButton("🔙 Kembali ke Menu", callback_data="menu")]]
    elif query.data == "contact":
        text = escape_markdown("📞 Hubungi Kami\nHubungi kami di Telegram: @kontak_kami atau email: info@example.com", version=2)
        keyboard = [[InlineKeyboardButton("🔙 Kembali ke Menu", callback_data="menu")]]
        ...
        text = escape_markdown(
            ...
            "/hijriyah - Cek Kalender Hijriyah\n"
            "/doa - Dapatkan Doa Harian\n"
            "/hadist - Dapatkan Hadist Acak", version=2
        )
        keyboard = [
            [InlineKeyboardButton("📜 Tentang Kami", callback_data="about"),
             InlineKeyboardButton("📞 Hubungi Kami", callback_data="contact")]
    ...
    # Menggunakan escape_markdown agar tidak error
